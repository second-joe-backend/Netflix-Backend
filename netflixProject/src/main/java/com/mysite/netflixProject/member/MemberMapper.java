...
public interface MemberMapper {
	...
	@Update("update member set member_pw=#{member_new_pw} where member_id=#{member_id}")
	...
	@Update("update member set member_tel=#{member_new_tel} where member_id=#{member_id}")
